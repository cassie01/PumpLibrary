...
"""
Part 2	N/A
开启泵并等待自检完成。	LCD屏幕亮起，泵进入停止状态。
选择输注模式为基本模式。	设置成功。
手动灌注和加载管路。	执行排气操作，当排气量达到6.00mL时，排气完成。
打开药物库。	设置成功。
 选择药物为NaCl。	设置成功。
设置速率为30mL/h，输液量为30mL。	设置成功。
按开始键开始输注。	泵处于运行状态。
输注完成。	泵端出现输注完成警报。
按停止键停止输注。	警报消除成功，泵处于停止状态。
设置速率为25mlL/ h，输液量为30mL。	设置成功。
按开始键开始输注。	泵处于运行状态。
输注完成。	屏幕出现输注完成警报。
按停止键停止输注。	警报消除成功，泵处于停止状态。
设置药物为红霉素。	设置成功。
设置速率为30mlL/ h，输液量为30mL。	设置成功。
按开始键开始输注。	泵处于运行状态。
输注完成。	屏幕出现输注完成警报。
按停止键停止输注。	警报消除成功，泵处于停止状态。
设置速率为25mlL/ h，输液量为30mL。	设置成功。
...
class TestClinicScenario(unittest.TestCase):
    ...
    def test_ClinicScenario_part_002(self):
